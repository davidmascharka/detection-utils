...
Let's see how the qualitative performance of our model, along with its confusion matrix (*averaged across all validation examples*) evolves across training.
Note that our model consistently struggles to detect the anomalously-small triangle near the right side of the image.
This size of shape is not well represented among the training examples, thus the model fails to generalize to detect it consistently.
...
<div style="text-align: center">
<p>
<img src="./pics/epoch_1.png" alt="Example detections and confusion matrix after 1 epoch of training">
</p>
</div>
...
<div style="text-align: center">
<p>
<img src="./pics/epoch_10.png" alt="Example detections and confusion matrix after 10 epochs of training">
</p>
</div>
...
<div style="text-align: center">
<p>
<img src="./pics/epoch_50.png" alt="Example detections and confusion matrix after 50 epochs of training">
</p>
</div>
...
<div style="text-align: center">
<p>
<img src="./pics/epoch_151.png" alt="Example detections and confusion matrix after 150 epochs of training">
</p>
</div>
